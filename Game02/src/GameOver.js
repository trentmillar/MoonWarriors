var GameOver = cc.Layer.extend({
    ...
    init:function () {
        ...
        if (this._super()) {
            ...
            var logo = cc.Sprite.create(s_image_gameover);
            logo.setAnchorPoint(cc.p(0,0));
            logo.setPosition(cc.p(0,300));
            this.addChild(logo,10,1);

            var playAgainNormal = cc.Sprite.create(s_image_menu, cc.rect(378, 0, 126, 33));
            var playAgainSelected = cc.Sprite.create(s_image_menu, cc.rect(378, 33, 126, 33));
            var playAgainDisabled = cc.Sprite.create(s_image_menu, cc.rect(378, 33 * 2, 126, 33));
